...
#         total_score = result_data.scores['q0'] + \
#             result_data.scores['q1'] + result_data.scores['q2'] + \
#             result_data.scores['q3'] + result_data.scores['q4'] + \
#             result_data.scores['q5'] + result_data.scores['q6'] + \
#             result_data.scores['q7'] + result_data.scores['q8'] + \
#             result_data.scores['q9']
